...
class SpanDetectorWorker(BaseWorker):
    ...
    FALLBACK_BAD_PHRASES = [
        "địt", "đụ", "đéo", "đm", "dm", "đmm", "lồn", "lon", "cặc", "cak",
        "vcl", "vkl", "vãi", "chó", "loz", "cc", "concac", "đỉa", "súc vật",
        "chết đi", "chết tiệt", "đồ ngu", "đồ khốn", "khốn nạn", "thối tha",
        "đồ dơ", "đồ bẩn", "ngu như", "ngu ngốc", "óc", "não", "chửi",
        "mẹ mày", "cha mày", "bố mày", "lão già", "con rắn", "đồ phản bội",
        "đồ bội bạc", "đồ phản", "phản đồ", "phản quốc", "phản động",
        "đồ bán nước", "bán nước", "bán rẻ", "tao thích", "cút đi", "câm mồm",
        "im mồm", "mồm", "câm đi", "thằng", "con", "đồ", "đéo biết"
    }
    ...
    SEVERE_HATE_INDICATORS = [
        "chết đi", "chết tiệt", "giết", "đánh đập", "phản quốc",
        "phản động", "bán nước", "đồ phản bội", "súc vật", "đồ bội bạc",
        "con rắn", "khốn nạn", "địt mẹ", "đụ má", "lồn mẹ"
    ]

    # Mild offensive indicators
    MILD_OFFENSIVE_INDICATORS = [
        "ngu", "óc chó", "đồ ngu", "ngu ngốc", "chó", "đéo", "vkl",
        "vcl", "thằng", "con", "mồm"
    ]
    ...
    def _detect_spans(self, text: str, request_id: Optional[str] = None) -> Dict[str, Any]:
        """
